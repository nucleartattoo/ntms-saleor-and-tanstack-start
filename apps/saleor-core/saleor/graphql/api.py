...
GraphQLLockSchemaDirective = graphql.GraphQLDirective(
    name="lockSchema",
    description="Compatibility directive for dashboard schema locking.",
    args={
        "schema": graphql.GraphQLArgument(
...
schema = build_federated_schema(
    ...
    + [GraphQLDocDirective, GraphQLWebhookEventsInfoDirective, GraphQLLockSchemaDirective],
)
